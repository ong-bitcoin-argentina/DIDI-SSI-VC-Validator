...
describe('livingPlace.v1.test', () => {
  ...
  it(`validate .vc.credentialSubject['Semillas Vivienda'].preview.type field FAIL`, async () => {
    expect.assertions(6);
  ...
  it(`validate .vc.credentialSubject['Semillas Vivienda'].data.type field FAIL`, async () => {
    expect.assertions(6);
  ...
  it(`validate .vc.credentialSubject.['Semillas Vivienda'].category.type field FAIL`, async () => {
    expect.assertions(6);
