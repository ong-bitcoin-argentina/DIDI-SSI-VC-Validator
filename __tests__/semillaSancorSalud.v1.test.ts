...
describe('semillaSancorSalud.v1.test', () => {
  ...
  it(`validate .vc.credentialSubject['Sancor Salud'].preview.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSancorSalud.v1,
      invalidPreviewJWT,
  ...
  it(`validate .vc.credentialSubject['Sancor Salud'].data.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSancorSalud.v1,
      invalidDataTypeJWT,
  ...
  it(`validate .vc.credentialSubject['Sancor Salud'].category.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSancorSalud.v1,
      invalidCategoryJWT,
