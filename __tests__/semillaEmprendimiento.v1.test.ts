...
describe('semillaEmprendimiento.v1.test', () => {
  ...
  it(`validate .vc.credentialSubject.Emprendimiento.preview.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaEmprendimiento.v1,
  ...
  it(`validate .vc.credentialSubject.Emprendimiento.data.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaEmprendimiento.v1,
      invalidDataTypeJWT,
  ...
  it(`validate .vc.credentialSubject.Emprendimiento.category.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaEmprendimiento.v1,
      invalidCategoryJWT,
