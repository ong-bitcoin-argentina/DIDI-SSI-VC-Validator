...
describe('semillaSembTitular.v1.test', () => {
  ...
  it(`validate .vc.credentialSubject['Semillas Beneficio'].preview.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSembTitular.v1,
      invalidPreviewJWT,
  ...
  it(`validate .vc.credentialSubject['Semillas Beneficio'].data.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSembTitular.v1,
      invalidDataTypeJWT,
  ...
  it(`validate .vc.credentialSubject['Semillas Beneficio'].category.type field FAIL`, async () => {
    expect.assertions(6);
    const result = await validateCredential(
      semillaSembTitular.v1,
      invalidCategoryJWT,
